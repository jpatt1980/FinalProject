...
1. Start with a basic introduction (it is permissible to repeat things from EDA file)
  ...
  - Variables identified as being candidates for prediction modeling: **HighBP**, **HighCholesterol**, **BMI**, **Smoker**, **PhysActivitiy**

  - Variables identifed as needing outliers removed: **BMI**
