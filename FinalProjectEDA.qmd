...
```{r histograms of BadPhysicalHealth by HasDiabetes}
...
```{r bar plot of DifficultyWalking by HasDiabetes}
...
```{r bar plot of Sex by HasDiabetes}
...
```{r bar plot of Age by HasDiabetes}
...
```{r bar plot of Education by HasDiabetes}
...
```{r bar plot of Income by HasDiabetes}
